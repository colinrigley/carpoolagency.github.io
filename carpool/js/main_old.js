...
$(function(){
    ...
    var currentPageName = "welcome";
    var currentPageIndex = 0;
    var $currentChapterElm = null;
    var $visibleChapter = null;
    var transitionDurationTime = 800;
    var lastScrollTop = 0;
    var isPostArticlePage = ($("#postArticle").length > 0) ? true : false;

    if (isPostArticlePage) {
        currentChapterName = "post";
    ...
    $(".pageNavLink").unbind("click").bind("click", function(event) {
        ...
        // For post article view, redirect to the corresponding page upon navigation selection
        if (isPostArticlePage) {
    ...
    $(window).scroll(function () {
        var self = this;
        var animationVideo1_offset;
        var animationVideo2_offset;
        var anchor_offset;
        var upper_anchor_offset;
        var lower_anchor_offset;


        if (!isPostArticlePage) {
            animationVideo1_offset = $("#welcome").height() / 10 - 100;
            animationVideo2_offset = $("#about").height() / 5 - 100;
